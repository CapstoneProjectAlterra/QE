...
for (i = 1; i <= 6; i++) {
    ...
    WebUI.click(findTestObject('CITIZEN/Page_Home  GetVaccine/a_Register'))
    ...
    if (i == 1) {
        ...
        WebUI.verifyElementVisible(findTestObject('CITIZEN/Page_Registrasi  GetVaccine/div_Format Email tidak valid'), FailureHandling.CONTINUE_ON_FAILURE)
    } else if (i == 5) {
        ...
        WebUI.verifyElementVisible(findTestObject('CITIZEN/Page_Registrasi  GetVaccine/div_NIK Tidak Boleh Kosong'), FailureHandling.CONTINUE_ON_FAILURE)
    }
...
for (i = 7; i <= 9; i++) {
    ...
    if (i == 7) {
        WebUI.verifyElementVisible(findTestObject('CITIZEN/Page_Registrasi  GetVaccine/alert blank field'), FailureHandling.CONTINUE_ON_FAILURE)
    } else if (i == 8) {
        WebUI.verifyElementVisible(findTestObject('CITIZEN/Page_Registrasi  GetVaccine/nik exist'), FailureHandling.CONTINUE_ON_FAILURE)
    } else {
        WebUI.verifyElementVisible(findTestObject('CITIZEN/Page_Login  GetVaccine/VerifyLoginPage'), FailureHandling.CONTINUE_ON_FAILURE)
    }
