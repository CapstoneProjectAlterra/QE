...
Mobile.setText(findTestObject('MOBILE/Login/nik'), findTestData('dataLogin').getValue(1, 5), 0)

Mobile.tap(findTestObject('MOBILE/Login/pass'), 0)

Mobile.setText(findTestObject('MOBILE/Login/pass'), findTestData('dataLogin').getValue(2, 5), 0)

Mobile.tap(findTestObject('MOBILE/Login/view pass'), 0)

Mobile.tap(findTestObject('MOBILE/Login/btn-login'), 0)

Mobile.verifyElementExist(findTestObject('MOBILE/Login/verify-home'), 0)
