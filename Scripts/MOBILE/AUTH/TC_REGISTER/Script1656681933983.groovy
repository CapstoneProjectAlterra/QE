...
for (i = 1; i <= 4; i++) {
    ...
    Mobile.tap(findTestObject('MOBILE/Register/namalengkap'), 0)

    Mobile.setText(findTestObject('MOBILE/Register/namalengkap'), findTestData('dataRegis').getValue(1, i), 0)

    Mobile.tap(findTestObject('MOBILE/Register/nik'), 0)

    Mobile.setText(findTestObject('MOBILE/Register/nik'), findTestData('dataRegis').getValue(2, i), 0)

    Mobile.tap(findTestObject('MOBILE/Register/email'), 0)

    Mobile.setText(findTestObject('MOBILE/Register/email'), findTestData('dataRegis').getValue(3, i), 0)

    Mobile.tap(findTestObject('MOBILE/regis baru/pass'), 0)

    Mobile.setText(findTestObject('MOBILE/regis baru/pass'), findTestData('dataRegis').getValue(4, i), 0)

    Mobile.tap(findTestObject('MOBILE/Register/view-pass'), 3)
