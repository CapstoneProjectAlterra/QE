...
WebUI.click(findTestObject('Page_Login Admin  GetVaccine/button_Login'))

WebUI.click(findTestObject('Object Repository/ADMIN/Adm-Logout/Page_Dashboard Admin  GetVaccine/span_Logout'))
