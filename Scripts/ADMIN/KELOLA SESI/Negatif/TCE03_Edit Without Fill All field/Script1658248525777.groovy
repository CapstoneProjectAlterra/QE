...
WebUI.click(findTestObject('Object Repository/ADMIN/Page_Kelola Sesi  GetVaccine/svg'))
...
WebUI.verifyElementPresent(findTestObject('Object Repository/ADMIN/Page_Kelola Sesi  GetVaccine/div_Jam mulai sesi harus diisi'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/ADMIN/Page_Kelola Sesi  GetVaccine/div_Jam selesai sesi harus diisi'), 
    0)

WebUI.verifyElementPresent(findTestObject('Object Repository/ADMIN/Page_Kelola Sesi  GetVaccine/div_Kuota vaksinasi harus diisi'), 
    0)
