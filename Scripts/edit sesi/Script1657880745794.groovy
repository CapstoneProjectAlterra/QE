...
WebUI.setText(findTestObject('Object Repository/Page_Kelola Sesi  GetVaccine/input_Kuota_quota'), findTestData('ADMIN/edit sesi').getValue(
        1, i))

WebUI.click(findTestObject('ADMIN/Kelola Sesi/EDIT SESI/button update'))

if (i == 1) {
    WebUI.verifyElementPresent(findTestObject('ADMIN/Kelola Sesi/EDIT SESI/alert kuota edit'), 0)

    WebUI.click(findTestObject('ADMIN/Kelola Sesi/EDIT SESI/button close'))
} else {
